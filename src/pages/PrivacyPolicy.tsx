  ...
  return (
    <Container maxWidth="md" sx={{ py: { xs: 8, md: 12 } }}>
      ...
      <Typography variant="body1" paragraph sx={{ mt: 4 }}>
        Insight Studios ("we", "us", or "our") is committed to protecting your
        privacy. This Privacy Policy explains how we collect, use, disclose, and
        safeguard your information when you visit our website
        (https://insightwebsolutions.com or any subdomain), use our services, or
        contact us.
      </Typography>
      ...
      <ul>
        <li>
          <strong>Personal Information</strong> you voluntarily provide (name,
          email address, phone number, message content) when you submit a
          contact form, request a quote, or communicate with us.
        </li>
        <li>
          <strong>Automatically Collected Data</strong> such as IP address,
          browser type, device information, pages visited, time spent on pages,
          and referring URLs (via cookies, analytics tools like Google
      ...
      <ul>
        <li>
          With service providers (hosting, email, analytics) who are bound to
          protect it
        </li>
      ...
      <Typography variant="body1" paragraph>
        ...
        You can manage preferences via your browser settings. We currently use
        Google Analytics (anonymized IP). For more details, see Google's privacy
        policy.
      </Typography>
      ...
      <Typography variant="body1" paragraph>
        ...
        delete, or opt out of certain uses of your data. Contact us at
        hello@insightwebsolutions.com to exercise these rights.
      </Typography>

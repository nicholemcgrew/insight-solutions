      ...
      <Box
        sx={{
          ...
          height: {
            ...
            md: `calc(100dvh - ${NAVBAR_HEIGHT.desktop}px)`,
          },
          mt: { xs: `${NAVBAR_HEIGHT.mobile}px`, md: `${NAVBAR_HEIGHT.desktop}px` },
          overflow: "auto",
          display: "flex",
          alignItems: "center",
        }}
          ...
          <Box sx={{ maxWidth: 1200, mx: "auto", width: "100%" }}>
            ...
            >
              ...
              >
                ...
                <Box component="span" sx={{ display: "block", position: "relative", height: "1.2em", mt: 0.15 }}>
                  <Box
                    component="span"
                    sx={{
                      position: "relative",
              ...
              <Typography
                sx={{
                  fontSize: { xs: "1.02rem", sm: "1.14rem", md: "1.22rem" },
                  lineHeight: 1.6,
                  maxWidth: 920,
                  opacity: 0.95,
                }}
              >
                We specialize in 508-compliant web development, high-SEO strategies, custom dashboards, and comprehensive analytics to drive your business forward.
              </Typography>

              <Box sx={{ display: "flex", gap: 2, flexWrap: "wrap", justifyContent: "center", mt: { xs: 2.5, md: 3 } }}>
                <Button variant="contained" color="secondary" size="large" component={NavLink} to="/pricing" sx={{ px: 4, py: 1.4 }}>
                  View Pricing
                </Button>
